...
export declare namespace StandardSchemaV1 {
  /** The Standard Schema properties type. */
  ...
  /** The result type if validation succeeds. */
  ...
  /** The issue type of the failure output. */
  export type Issue = {
  ...
  /** The Standard Schema types type. */
