...
Raypx is a pnpm monorepo orchestrated by Turborepo. It contains **3 applications** and **14 shared packages** that work together to provide a complete full-stack development platform.
...
| **@raypx/validators** | Validation schemas | Zod schemas for API and forms |
